...
export function GameTable({ players, communityCards, pot, dealerIdx, currentTurnIdx, stage, logs, winners, winningCards }: TableProps) {
  ...
  const positions = [
    ...
    "bottom-[8%] left-[6%] xl:bottom-[12%] xl:left-[-5%] z-10",                              // P1 - 左下角
    "top-[28%] left-[2%] xl:top-[25%] xl:left-[-8%] z-10",                                  // P2 - 左侧中间
    "top-[-10%] left-[15%] xl:top-[-8%] xl:left-[12%] z-10",                                 // P3 - 顶部左侧
    "top-[-20%] left-1/2 -translate-x-1/2 z-10",                                             // P4 - 顶部中央
    "top-[-10%] right-[15%] xl:top-[-8%] xl:right-[12%] z-10",                               // P5 - 顶部右侧
    "top-[28%] right-[2%] xl:top-[25%] xl:right-[-8%] z-10",                                 // P6 - 右侧中间
    "bottom-[8%] right-[6%] xl:bottom-[12%] xl:right-[-5%] z-10",                            // P7 - 右下角
  ];

  return (
    // Mobile: much taller (1/1.5) to fit logs. Desktop: wider (1/0.6).
    <div className="relative w-full max-w-[900px] h-auto max-h-[65vh] aspect-[1/1] lg:aspect-[1/0.75] xl:aspect-[1/0.7] mx-auto flex-shrink-0 transition-all duration-300 my-12 lg:my-16">
      {/* The Felt Table */}
      <div className="absolute inset-0 bg-gray-200 dark:bg-zinc-900 border-[8px] sm:border-[12px] border-gray-300 dark:border-zinc-800 rounded-[100px] sm:rounded-[200px] shadow-[inset_0_0_60px_rgba(0,0,0,0.1)] dark:shadow-[inset_0_0_60px_rgba(0,0,0,0.5)]">
        ...
        <div className="absolute inset-0 flex flex-col items-center pointer-events-none z-0">
          ...
          <div className="flex flex-col items-center w-full origin-center scale-[0.8] sm:scale-100 lg:scale-[0.9] xl:scale-100 transition-transform">
            {/* Pot Display */}
            ...
            {/* Community Cards */}
            <div className="my-[4%] lg:my-[2%] flex gap-1 sm:gap-2 items-center justify-center w-full px-2 pointer-events-auto z-10">
